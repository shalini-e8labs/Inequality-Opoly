...
function App() {
	...
	/*useEffect(() => {
		const script = document.createElement('script');
		script.src = "./js/gameboard_animation.js";
		script.async = true;
		document.body.appendChild(script);
		return () => {
			document.body.removeChild(script);
						...
						<div className="player_card_wapper">
							<div className="player_cared_user">
								<div className="playser_with_money">
									<img src="img/Component 13 – 3 - Copy.png" />
									<div className="Playser_data">
										<h3 className="player_user_name">JANET</h3>
										<span>$11,000</span>
									</div>
								</div>
							</div>
						...
						<div className="gameplay_game" >
							...
							<table className="Gameboard-playboard">
								<tr>
									...
									<td className="Gameboard-playboard-card Gameboard-playboard-19"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-20"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-21"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-22"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-23"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-24"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-25"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-26"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-27"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-jack_poTi"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-18"></td>
									<td className="center_gmaeboard" colspan="9" rowspan="9" ></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-28"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-17"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-29"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-16"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-30"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-15"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-31"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-14"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-32"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-13"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-33"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-12"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-34"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-11"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-35"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-10"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-36"></td>
								</tr>
								<tr>
									<td className="Gameboard-playboard-card Gameboard-playboard-9"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-8"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-7"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-6_1"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-6"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-5"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-4"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-3"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-2"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-1"></td>
									<td className="Gameboard-playboard-card Gameboard-playboard-start"></td>
								</tr>
							</table>
						</div>
					</div>
